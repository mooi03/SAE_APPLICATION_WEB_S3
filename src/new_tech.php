...
<div class="petit_grand_parent">
  <div class="gauche">
    <div class="parent_bouton">
      <a href="admin_system.php" class="lien_bouton"> <img src="logo.PNG" class="img_bouton"> <p>admin system</p></a>
      <a href="" class="lien_bouton" style="background-color: #9c9ca1"> <img src="logo.PNG" class="img_bouton"> <p>nouveau tech</p></a>
    </div>
  </div>
  <div class="bas centre">
    <div class="stat stat_100 pour_form mdp_uu">
      <div class="titre"><p>Nouveau techenicien</p></div>
      <form action="enregistrement_tech.php" class="form" method="post">
